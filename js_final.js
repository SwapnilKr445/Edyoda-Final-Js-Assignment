...
productList1= [
  ...
  for(var i in productList){
     // console.log(i);
         ...
         div_tag.className = "product_bx"
         for(var j in productList[i]){
             // console.log(j, productList[i][j]);
             if(j == "preview"){
                 var img_tag = document.createElement('img');
                 img_tag.src = productList[i][j];
                 var a_tag = document.createElement('a');
                 a_tag.href="js_final_2.html";
                 a_tag.target="blank";
                 a_tag.appendChild(img_tag);
                 //img_tag.alt="js_final_2.html";
                console.log(a_tag);
                ...
                var p_tag=document.createElement('h3');
                p_tag.innerHTML +=productList[i][j];
                // console.log(p_tag)
             ...
             var p_tag=document.createElement('h4');
             p_tag.innerHTML +=productList[i][j];
             // console.log(p_tag)
             div_tag.appendChild(p_tag);
             ...
             var p_tag=document.createElement('h5');
             p_tag.innerHTML +="Rs"+" "+productList[i][j];
             // console.log(p_tag)
             div_tag.appendChild(p_tag);
            ...
            // else{
            //     div_tag.innerHTML += j+ " :- " +productList[i][j]+"<br>"
            // }
    ...
    for(var i in productList1){
        // console.log(i);
            var div_tag = document.createElement('div');
            div_tag.className = "product_bx"
            for(var j in productList1[i]){
                // console.log(j, productList[i][j]);
                if(j == "preview"){
                    var img_tag = document.createElement('img');
                    img_tag.src = productList1[i][j];
                   // console.log(img_tag);
                    img_tag.className = "img_style"
                   ...
                   var p_tag=document.createElement('h3');
                   p_tag.innerHTML +=productList1[i][j];
                   // console.log(p_tag)
                   div_tag.appendChild(p_tag);
                ...
                var p_tag=document.createElement('h5');
                p_tag.innerHTML +="Rs"+" "+productList1[i][j];
                // console.log(p_tag)
                div_tag.appendChild(p_tag);
           ...
           // console.log(div_tag)
            document.getElementById('main_section1').appendChild(div_tag);
       }
